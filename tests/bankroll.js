...
let baseBetPct = 0.25;           //Amount of bankroll to wager after a win
...
let martingaleMultiplier =1;               //Multiply previous bet by this number after a loss
let goal =.2                               //How much do you want to make
let payout = 1.5                        //How much do you make on a winning bet
let odds = 0.66                             //Chance of winning each time

let maxRuns = 1000;                   //A run ends when the player is bankrupt or they've met their goal
...
for (var runs=0; runs<maxRuns; runs++) {
    ...
    while (bankroll < goal && bankroll > 0.001) {
